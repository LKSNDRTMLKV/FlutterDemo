...
import 'package:bookstore/src/screens/member_details.dart';
import 'package:bookstore/src/screens/members.dart';
import 'package:bookstore/src/widgets/member_list.dart';
      ...
      routerConfig: GoRouter(
        ...
        routes: [
                        ...
                        child: Builder(
                          builder: (context) {
                            return FutureBuilder<List<Member>>(
                              future: MemberState().getMembers(),
                              builder: (context, snapshot) {
                                return MemberList(
                                  snapshot: snapshot,
                                  onTap: (member) {
                                    GoRouter.of(context)
                                        .go('/members/all/member/${member.id}');
                                  },
                                );
                              },
                            );
                      ...
                      GoRoute(
                        ...
                        builder: (context, state) {
                          ...
                          return FutureBuilder<Member>(
                            future: memberState.selectMember(
                                int.parse(state.pathParameters['memberId']!)),
                            builder: (context, snapshot) {
                              return MemberDetailsScreen(snapshot: snapshot);
                            },
                          );
                        },
                      ),
          ...
          GoRoute(
            path: '/sign-in',
            builder: (context, state) {
              // Use a builder to get the correct BuildCont
              return Builder(
                builder: (context) {
                  return SignInScreen(
